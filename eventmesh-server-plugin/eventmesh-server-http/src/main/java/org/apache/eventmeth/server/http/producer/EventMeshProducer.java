...
package org.apache.eventmeth.server.http.producer;
...
public class EventMeshProducer {
    ...
    public synchronized void init(ProducerGroupConf producerGroupConfig) throws Exception {
        ...
        keyValue.put("instanceName", EventMeshUtils.buildMeshClientID(producerGroupConfig.getGroupName(), CommonConfiguration.eventMeshCluster));
