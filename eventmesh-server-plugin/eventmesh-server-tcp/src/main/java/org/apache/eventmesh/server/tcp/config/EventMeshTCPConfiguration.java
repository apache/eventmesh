...
public enum EventMeshTCPConfiguration {
    ...
    public static int gracefulShutdownSleepIntervalInMills = 1000;

    public static int sleepIntervalInRebalanceRedirectMills = 200;
    ...
    private static void refreshConfig() {
        ...
        gracefulShutdownSleepIntervalInMills = yamlConfigurationReader.getInt(ConfKeys.KEYS_EVENTMESH_SERVER_GRACEFUL_SHUTDOWN_SLEEP_TIME, gracefulShutdownSleepIntervalInMills);

        sleepIntervalInRebalanceRedirectMills = yamlConfigurationReader.getInt(ConfKeys.KEYS_EVENTMESH_SERVER_REBALANCE_REDIRECT_SLEEP_TIME, sleepIntervalInRebalanceRedirectMills);
    }
