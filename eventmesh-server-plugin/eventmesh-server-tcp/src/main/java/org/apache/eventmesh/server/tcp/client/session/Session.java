...
package org.apache.eventmesh.server.tcp.client.session;
...
import org.apache.eventmesh.server.tcp.client.group.ClientGroupWrapper;
...
import org.apache.eventmesh.server.tcp.session.SessionPusher;
import org.apache.eventmesh.server.tcp.session.SessionSender;
...
public class Session {
    ...
    public String toString() {
        return "Session{" +
                ...
                ",remoteAddr=" + ChannelUtils.parseSocketAddressAddr(remoteAddress) +
                ",client=" + client +
                ...
                ",lastHeartbeatTime=" + DateFormatUtils.format(lastHeartbeatTime, TcpProtocolConstants.DATE_FORMAT) + '}';
    }
