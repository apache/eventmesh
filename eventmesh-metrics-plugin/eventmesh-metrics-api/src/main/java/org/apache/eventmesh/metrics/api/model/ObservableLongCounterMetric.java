...
public class ObservableLongCounterMetric extends AbstractObservableLongMetric {
    ...
    public ObservableLongCounterMetric(InstrumentFurther further, String metricName, Supplier<Long> supplier) {
        super(further, metricName, supplier);
    }

    public ObservableLongCounterMetric(String metricName) {
