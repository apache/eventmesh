...
public class SubjectCreateRequest extends SchemaCreateRequest {
	  ...
	  @JsonCreator
	  public SubjectCreateRequest(@JsonProperty("tenant") String tenant,
	  ...
	  public String toString() {
	    ...
	    sb.append("SchemaRequest {tenant=" + this.tenant + ",");
