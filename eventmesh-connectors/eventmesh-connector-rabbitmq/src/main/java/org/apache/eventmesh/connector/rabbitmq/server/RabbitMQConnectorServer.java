...
public class RabbitMQConnectorServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (serverConfig.isSourceEnable()) {
            Application rabbitmqSourceApp = new Application();
            rabbitmqSourceApp.run(RabbitMQSourceConnector.class);
        }

        if (serverConfig.isSinkEnable()) {
            Application rabbitmqSinkApp = new Application();
            rabbitmqSinkApp.run(RabbitMQSinkConnector.class);
        }
    }
}
