 ...
 * {@link #deliver(URI, HttpConnectRecord, Map, ConnectRecord)}, and {@link #stop()} methods.</p>
 *
 ...
 * on specified URL while returning its own processing logic {@link #stop()} method releases any resources used for HTTP/HTTPS communication.</p>
 *
 * <p>It's recommended to handle exceptions gracefully within the {@link #deliver(URI, HttpConnectRecord, Map, ConnectRecord)} method
...
public interface McpSinkHandler {
     ...
     */
    Future<HttpResponse<Buffer>> deliver(URI url, HttpConnectRecord httpConnectRecord, Map<String, Object> attributes, ConnectRecord connectRecord);
