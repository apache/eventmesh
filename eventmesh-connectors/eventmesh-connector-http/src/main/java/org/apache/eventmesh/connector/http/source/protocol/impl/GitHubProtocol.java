...
import org.apache.eventmesh.connector.http.source.config.GitHubConfig;
...
public class GitHubProtocol implements Protocol {
    ...
    public void initialize(SourceConnectorConfig sourceConnectorConfig) {
        // Initialize the protocol
        gitHubConfig = sourceConnectorConfig.getGithub();
    }
    ...
    public void setHandler(Route route, BlockingQueue<Object> queue) {
        route.method(HttpMethod.POST)
            ...
            .handler(ctx -> {
                ...
                if (BooleanUtils.isFalse(validateSignature(signature, payload, gitHubConfig.getSecret()))) {
