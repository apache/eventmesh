...
public class TextType extends StringEventMeshDataType {

    public static final TextType INSTANCE = new TextType();

    private static final List<String> TEXT_REGISTRATION_KEYS = Arrays.asList("TEXT", "text", "MEDIUMTEXT", "mediumtext", "LONGTEXT", "longtext");

    @Override
    public List<String> ofRegistrationKeys() {
        return TEXT_REGISTRATION_KEYS;
    }
