...
public class RandomTaskSelectStrategy<Task extends EventMeshJdbcTask> implements TaskSelectStrategy<Task> {

    private List<Task> cdcTasks;

    public RandomTaskSelectStrategy(List<Task> cdcTasks) {
