...
public class InsertDataEvent extends GeneralDataChangeEvent {

    public InsertDataEvent(TableId tableId) {
        super(tableId);
    }

    public InsertDataEvent(TableId tableId, JdbcConnectData data) {
        super(tableId, data);
    }
