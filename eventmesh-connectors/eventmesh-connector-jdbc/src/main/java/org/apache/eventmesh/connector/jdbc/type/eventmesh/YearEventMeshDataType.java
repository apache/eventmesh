...
public class YearEventMeshDataType extends AbstractType<Integer> {

    public static final YearEventMeshDataType INSTANCE = new YearEventMeshDataType();

    private YearEventMeshDataType() {
