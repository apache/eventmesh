...
public class DeleteDataEvent extends GeneralDataChangeEvent {

    public DeleteDataEvent(TableId tableId) {
        super(tableId);
    }

    public DeleteDataEvent(TableId tableId, JdbcConnectData data) {
        super(tableId, data);
    }
