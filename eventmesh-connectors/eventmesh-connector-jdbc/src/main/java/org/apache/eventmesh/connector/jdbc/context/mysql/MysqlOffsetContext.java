...
import org.apache.eventmesh.connector.jdbc.UniversalOffsetContext;

import java.util.Map;

public class MysqlOffsetContext extends UniversalOffsetContext {
    ...
    @Override
    public void markSnapshotRunning() {
