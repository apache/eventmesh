...
public class DropTableEvent extends GeneralSchemaChangeEvent {

    public DropTableEvent(TableId tableId) {
        super(tableId);
    }

    public DropTableEvent(TableId tableId, JdbcConnectData data) {
        super(tableId, data);
    }
    ...
    public SchemaChangeEventType getSchemaChangeEventType() {
        return SchemaChangeEventType.TABLE_DROP;
    }
}
