...
public class MediumintType extends NumberType<Integer> {

    public static final MediumintType INSTANCE = new MediumintType();

    public MediumintType() {
        super(Integer.class, SQLType.INTEGER, "MEDIUMINT");
    }

    @Override
    public String getTypeName(Column<?> column) {
        StringBuilder typeNameBuilder = new StringBuilder(" mediumint ");
    ...
    public List<String> ofRegistrationKeys() {
        return Arrays.asList("mediumint", getName());
    }
}
