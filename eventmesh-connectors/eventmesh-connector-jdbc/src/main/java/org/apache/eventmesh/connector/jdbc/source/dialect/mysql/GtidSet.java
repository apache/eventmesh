...
public final class GtidSet {
    ...
    /**
     * Retrieves the beginning GTID set.
     *
    ...
    public GtidSet getGtidSetBeginning() {
        ...
        // Iterate over each UUID set for each server ID
        for (UUIDSet uuidSet : uuidSetsByServerId.values()) {
            // Store the beginning state of each UUID set as the value in the new set, with UUID as the key
    ...
    public static class UUIDSet {
        ...
        /**
         * Determine if the set of transaction numbers from this server is completely within the set of transaction numbers from the set of
         * transaction numbers in the supplied set.
         *
         * @param other the set to compare with this set
         * @return {@code true} if this server's transaction numbers are a subset of the transaction numbers of the supplied set, or false otherwise
         */
    ...
    public static class Interval implements Comparable<Interval> {
         ...
         * @return {@code true} if the {@link #getStart() start} is greater than or equal to the supplied interval's {@link #getStart() start} and the
         * {@link #getEnd() end} is less than or equal to the supplied interval's {@link #getEnd() end}, or {@code false} otherwise
         */
