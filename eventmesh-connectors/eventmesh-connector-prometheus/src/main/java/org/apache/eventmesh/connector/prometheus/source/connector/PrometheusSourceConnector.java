...
public class PrometheusSourceConnector implements Source {
    ...
    public List<ConnectRecord> poll() {
        try {
            queryPrometheusReq.setStart(curStartTime);
            queryPrometheusReq.setEnd(curStartTime + interval);
            ...
            for (String data : responseData.getData().getResult()) {
                ...
                RecordOffset recordOffset = convertToRecordOffset(curStartTime);
    ...
    private RecordOffset convertToRecordOffset(Long time) {
        Map<String, String> offsetMap = new HashMap<>();
        offsetMap.put("queueOffset", time + "");
