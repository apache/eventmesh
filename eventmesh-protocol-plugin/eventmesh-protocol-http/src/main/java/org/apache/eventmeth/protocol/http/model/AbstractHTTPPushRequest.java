...
import org.apache.eventmeth.protocol.http.utils.HTTPClientPool;
...
public abstract class AbstractHTTPPushRequest extends RetryContext {
    ...
    public void delayRetry() {
        if (retryTimes < HttpProtocolConstants.DEFAULT_PUSH_RETRY_TIMES) {
            retryTimes++;
            delay(retryTimes * HttpProtocolConstants.DEFAULT_PUSH_RETRY_TIME_DISTANCE_IN_MILLSECONDS);
