...
import org.apache.eventmeth.protocol.http.consumer.EventMeshConsumer;
...
public class HandleMsgContext {
    ...
    public HandleMsgContext(String msgRandomNo, String consumerGroup, EventMeshConsumer eventMeshConsumer,
                            ...
                            EventMeshProtocolHTTPServer eventMeshHTTPServer, String bizSeqNo, String uniqueId, ConsumerGroupTopicConf consumeTopicConfig) {
