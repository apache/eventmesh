...
import org.apache.eventmeth.protocol.http.retry.RetryContext;
...
public class SendMessageContext extends RetryContext {
    ...
    public EventMeshProtocolHTTPServer eventMeshHTTPServer;

    private List<Message> messageList;

    public SendMessageContext(String bizSeqNo, Message msg, EventMeshProducer eventMeshProducer, EventMeshProtocolHTTPServer eventMeshHTTPServer) {
    ...
    public boolean retry() throws Exception {
        ...
        eventMeshProducer.send(this, new SendCallback() {
            ...
            public void onException(OnExceptionContext context) {
                ...
                eventMeshHTTPServer.getMetricsServer().summaryMetrics.recordSendBatchMsgFailed(1);
            }
