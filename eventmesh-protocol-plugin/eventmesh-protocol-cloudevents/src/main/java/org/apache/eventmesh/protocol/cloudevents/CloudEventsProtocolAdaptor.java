...
public class CloudEventsProtocolAdaptor<T extends ProtocolTransportObject>
    ...
    switch (requestCode) {
        case String.valueOf(RequestCode.MSG_BATCH_SEND):
            return SendMessageBatchProtocolResolver.buildEvent(header, body);
        case String.valueOf(RequestCode.MSG_BATCH_SEND_V2):
            return SendMessageBatchV2ProtocolResolver.buildEvent(header, body);
        case String.valueOf(RequestCode.MSG_SEND_SYNC):
        case String.valueOf(RequestCode.MSG_SEND_ASYNC):
