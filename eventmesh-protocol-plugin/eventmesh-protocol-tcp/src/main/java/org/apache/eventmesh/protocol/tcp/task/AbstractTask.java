...
public abstract class AbstractTask implements Runnable {
    ...
    protected       EventMeshProtocolTCPServer eventMeshTCPServer;

    public AbstractTask(Package pkg, ChannelHandlerContext ctx, long startTime, EventMeshProtocolTCPServer eventMeshTCPServer) {
