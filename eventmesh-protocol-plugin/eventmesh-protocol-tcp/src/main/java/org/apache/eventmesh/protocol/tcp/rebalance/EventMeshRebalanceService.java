 ...
 */
package org.apache.eventmesh.protocol.tcp.rebalance;
...
public class EventMeshRebalanceService {
    ...
    public EventMeshRebalanceService(EventMeshProtocolTCPServer eventMeshTCPServer, EventMeshRebalanceStrategy rebalanceStrategy) {
