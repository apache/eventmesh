...
public class EventMeshTcp2Client {
    ...
    public static InetSocketAddress serverGoodby2Client(EventMeshProtocolTCPServer eventMeshTCPServer, Session session, ClientSessionGroupMapping mapping) {
    ...
    public static InetSocketAddress goodBye2Client(EventMeshProtocolTCPServer eventMeshTCPServer,
                                                   Session session,
                                                   String errMsg,
                                                   int eventMeshStatus,
    ...
    public static String redirectClient2NewEventMesh(EventMeshProtocolTCPServer eventMeshTCPServer, String newEventMeshIp, int port, Session session, ClientSessionGroupMapping mapping) {
    ...
    public static void closeSessionIfTimeout(EventMeshProtocolTCPServer eventMeshTCPServer, Session session, ClientSessionGroupMapping mapping) {
