...
public class RMBTraceLogResponseHeader extends Header {
    ...
    public static RMBTraceLogResponseHeader buildHeader(Integer requestCode, String proxyCluster,
                                                        String proxyIp, String proxyEnv, String proxyRegion,
                                                        String proxyDcn, String proxyIDC) {
        RMBTraceLogResponseHeader rmbTraceLogResponseHeader = new RMBTraceLogResponseHeader();
        rmbTraceLogResponseHeader.setCode(requestCode);
        rmbTraceLogResponseHeader.setProxyCluster(proxyCluster);
        rmbTraceLogResponseHeader.setProxyDcn(proxyDcn);
        rmbTraceLogResponseHeader.setProxyIp(proxyIp);
        rmbTraceLogResponseHeader.setProxyEnv(proxyEnv);
        rmbTraceLogResponseHeader.setProxyRegion(proxyRegion);
        rmbTraceLogResponseHeader.setProxyIdc(proxyIDC);
        return rmbTraceLogResponseHeader;
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("rmbTraceLogResponseHeader={")
