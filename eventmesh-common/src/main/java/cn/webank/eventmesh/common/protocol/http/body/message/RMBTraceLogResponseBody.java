...
public class RMBTraceLogResponseBody extends Body {
    ...
    public static RMBTraceLogResponseBody buildBody(Integer retCode, String retMsg) {
        RMBTraceLogResponseBody rmbTraceLogResponseBody = new RMBTraceLogResponseBody();
        rmbTraceLogResponseBody.setRetMsg(retMsg);
        rmbTraceLogResponseBody.setResTime(System.currentTimeMillis());
        rmbTraceLogResponseBody.setRetCode(retCode);
        return rmbTraceLogResponseBody;
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("rmbTraceLogResponseBody={")
