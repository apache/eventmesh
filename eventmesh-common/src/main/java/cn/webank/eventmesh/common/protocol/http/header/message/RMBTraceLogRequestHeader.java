...
public class RMBTraceLogRequestHeader extends Header {
    ...
    public static RMBTraceLogRequestHeader buildHeader(Map<String, Object> headerParam) {
        RMBTraceLogRequestHeader header = new RMBTraceLogRequestHeader();
    ...
    public String toString() {
        ...
        sb.append("RMBTraceLogRequestHeader={")
