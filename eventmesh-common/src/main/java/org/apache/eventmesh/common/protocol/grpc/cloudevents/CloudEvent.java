...
public final class CloudEvent extends
    ...
    public DataCase getDataCase() {
        return Objects.requireNonNull(DataCase.forNumber(dataCase_));
    }
    ...
    private com.google.protobuf.MapField<String, CloudEventAttributeValue> internalGetAttributes() {
        if (attributes_ == null) {
    ...
    public int getSerializedSize() {
        ...
        for (java.util.Map.Entry<String, CloudEventAttributeValue> entry
            ...
            size += com.google.protobuf.CodedOutputStream
                .computeMessageSize(5, attributes);
        }
    ...
    public static final class CloudEventAttributeValue extends
        ...
        public AttrCase getAttrCase() {
            return Objects.requireNonNull(AttrCase.forNumber(attrCase_));
        }
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output)
            ...
            switch (attrCase_) {
                case 1:
                    output.writeBool(1, (Boolean) attr_);
                    break;
                case 2:
                    output.writeInt32(2, (Integer) attr_);
                    break;
                case 3:
        ...
        public boolean equals(final Object obj) {
            ...
            if (!getAttrCase().equals(other.getAttrCase())) {
                return false;
            }
            switch (attrCase_) {
                case 1:
                ...
                case 3:
                    if (!getCeString()
                        .equals(other.getCeString())) {
                        return false;
                    }
                    break;
                case 4:
                    if (!getCeBytes()
                        .equals(other.getCeBytes())) {
                        return false;
                    }
                    break;
                case 5:
                    if (!getCeUri()
                        .equals(other.getCeUri())) {
                        return false;
                    }
                    break;
                case 6:
                    if (!getCeUriRef()
                        .equals(other.getCeUriRef())) {
                        return false;
                    }
                    break;
                case 7:
                    if (!getCeTimestamp()
                        .equals(other.getCeTimestamp())) {
                        return false;
                    }
                    break;
                case 0:
        ...
        public static final class Builder extends
            ...
            public Builder mergeFrom(CloudEventAttributeValue other) {
                if (other == CloudEventAttributeValue.getDefaultInstance()) {
                    return this;
                }
                switch (Objects.requireNonNull(other.getAttrCase())) {
                    case CE_BOOLEAN: {
    ...
    public static final class Builder extends
        ...
        public Builder mergeFrom(CloudEvent other) {
            if (other == CloudEvent.getDefaultInstance()) {
                return this;
            }
            ...
            internalGetMutableAttributes().mergeFrom(
                other.internalGetAttributes());
            switch (Objects.requireNonNull(other.getDataCase())) {
                case BINARY_DATA: {
         ...
         */
        @Override
        public CloudEventAttributeValue getAttributesOrThrow(String key) {
            if (key == null) {
                throw new NullPointerException("map key");
            }
            java.util.Map<String, CloudEventAttributeValue> map =
         ...
         */
        @Deprecated
        public java.util.Map<String, CloudEventAttributeValue> getMutableAttributes() {
