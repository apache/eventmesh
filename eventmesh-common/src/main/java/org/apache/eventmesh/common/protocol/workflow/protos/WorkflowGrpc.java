...
/**
 */
@javax.annotation.Generated(value = "by gRPC proto compiler (version 1.49.1-SNAPSHOT)", comments = "Source: workflow.proto")
...
public final class WorkflowGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<ExecuteRequest, ExecuteResponse> getExecuteMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
            + "Execute", requestType = ExecuteRequest.class, responseType = ExecuteResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<ExecuteRequest, ExecuteResponse> getExecuteMethod() {
            ...
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            ...
                            io.grpc.stub.ServerCalls.asyncUnaryCall(
                                    new MethodHandlers<ExecuteRequest, ExecuteResponse>(
