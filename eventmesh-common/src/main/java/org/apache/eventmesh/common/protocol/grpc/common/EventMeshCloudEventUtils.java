...
public class EventMeshCloudEventUtils {
    ...
    private final DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern(Constants.DATE_FORMAT_DEFAULT);

    private String getValue(CloudEvent cloudEvent, String defaultValue, String protocolKey) {
        try {
    ...
    public String getEnv(CloudEvent cloudEvent) {
        return getEnv(cloudEvent, null);
    }

    public String getEnv(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.ENV);
    }

    public String getIdc(CloudEvent cloudEvent) {
        return getIdc(cloudEvent, null);
    }

    public String getIdc(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.IDC);
    }

    public String getSys(CloudEvent cloudEvent) {
        return getSys(cloudEvent, null);
    }

    public String getSys(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.SYS);
    }

    public String getPid(CloudEvent cloudEvent) {
        return getPid(cloudEvent, null);
    }

    public String getPid(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.PID);
    }

    public String getIp(CloudEvent cloudEvent) {
        return getIp(cloudEvent, null);
    }

    public String getIp(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.IP);
    }

    public String getUserName(CloudEvent cloudEvent) {
        return getUserName(cloudEvent, null);
    }

    public String getUserName(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.USERNAME);
    }

    public String getPassword(CloudEvent cloudEvent) {
        return getPassword(cloudEvent, null);
    }

    public String getPassword(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.PASSWD);
    }

    public String getLanguage(CloudEvent cloudEvent) {
        return getLanguage(cloudEvent, null);
    }

    public String getLanguage(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.LANGUAGE);
    }

    public String getProtocolType(CloudEvent cloudEvent) {
        return getProtocolType(cloudEvent, null);
    }

    public String getProtocolType(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.PROTOCOL_TYPE);
    }

    public String getProtocolVersion(CloudEvent cloudEvent) {
        return getProtocolVersion(cloudEvent, null);
    }

    public String getProtocolVersion(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.PROTOCOL_VERSION);
    }

    public String getProtocolDesc(CloudEvent cloudEvent) {
        return getProtocolDesc(cloudEvent, null);
    }

    public String getProtocolDesc(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.PROTOCOL_DESC);
    }

    public String getSeqNum(CloudEvent cloudEvent) {
        return getSeqNum(cloudEvent, null);
    }

    public String getSeqNum(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.SEQ_NUM);
    }

    public String getUniqueId(CloudEvent cloudEvent) {
        return getUniqueId(cloudEvent, null);
    }

    public String getUniqueId(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.UNIQUE_ID);
    }

    public String getTtl(CloudEvent cloudEvent) {
        return getTtl(cloudEvent, null);
    }

    public String getTtl(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.TTL);
    }

    public String getProducerGroup(CloudEvent cloudEvent) {
        return getProducerGroup(cloudEvent, null);
    }

    public String getProducerGroup(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.PRODUCERGROUP);
    }

    public String getTag(CloudEvent cloudEvent) {
        return getTag(cloudEvent, null);
    }

    public String getTag(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.TAG);
    }

    public String getContentType(CloudEvent cloudEvent) {
        return getContentType(cloudEvent, null);
    }

    public String getContentType(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.CONTENT_TYPE);
    }

    public String getSubject(CloudEvent cloudEvent) {
        return getSubject(cloudEvent, null);
    }

    public String getSubject(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.SUBJECT);
    }

    public String getDataContentType(CloudEvent cloudEvent) {
        return getDataContentType(cloudEvent, null);
    }

    public String getDataContentType(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.DATA_CONTENT_TYPE);
    }

    public String getResponseCode(CloudEvent cloudEvent) {
        return getResponseCode(cloudEvent, null);
    }

    public String getResponseCode(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.GRPC_RESPONSE_CODE);
    }

    public String getResponseMessage(CloudEvent cloudEvent) {
        return getResponseMessage(cloudEvent, null);
    }

    public String getResponseMessage(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.GRPC_RESPONSE_MESSAGE);
    }

    public String getResponseTime(CloudEvent cloudEvent) {
        return getResponseTime(cloudEvent, null);
    }

    public String getResponseTime(CloudEvent cloudEvent, String defaultValue) {
        try {
    ...
    public String getCluster(CloudEvent cloudEvent) {
        return getCluster(cloudEvent, null);
    }

    public String getCluster(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.PROPERTY_MESSAGE_CLUSTER);
    }

    public String getConsumerGroup(CloudEvent cloudEvent) {
        return getConsumerGroup(cloudEvent, null);
    }

    public String getConsumerGroup(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.CONSUMERGROUP);
    }

    public ClientType getClientType(CloudEvent cloudEvent) {
        return getClientType(cloudEvent, null);
    }

    public ClientType getClientType(CloudEvent cloudEvent, ClientType defaultValue) {
        try {
    ...
    public String getURL(CloudEvent cloudEvent) {
        return getURL(cloudEvent, null);
    }

    public String getURL(CloudEvent cloudEvent, String defaultValue) {
        return getValue(cloudEvent, defaultValue, ProtocolKey.URL);
    }

    public String getDataContent(CloudEvent cloudEvent) {
        return getDataContent(cloudEvent, null);
    }

    public String getDataContent(final CloudEvent cloudEvent, String defaultValue) {
    ...
    public Map<String, String> getAttributes(final CloudEvent cloudEvent) {
