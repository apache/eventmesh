...
public final class CatalogGrpc {
  ...
  public static io.grpc.MethodDescriptor<QueryRequest,
    ...
    if ((getQueryMethod = CatalogGrpc.getQueryMethod) == null) {
      synchronized (CatalogGrpc.class) {
        if ((getQueryMethod = CatalogGrpc.getQueryMethod) == null) {
          CatalogGrpc.getQueryMethod = getQueryMethod =
              ...
              .setSchemaDescriptor(new CatalogMethodDescriptorSupplier("Query"))
              .build();
        }
      }
    }
