 ...
 *
 */
@javax.annotation.Generated(value = "by gRPC proto compiler (version 1.49.1-SNAPSHOT)", comments = "Source: catalog.proto")
...
public final class CatalogGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<RegistryRequest, RegistryResponse> getRegistryMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
            + "Registry", requestType = RegistryRequest.class, responseType = RegistryResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<RegistryRequest, RegistryResponse> getRegistryMethod() {
    ...
    private static volatile io.grpc.MethodDescriptor<QueryOperationsRequest, QueryOperationsResponse> getQueryOperationsMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
            + "QueryOperations", requestType = QueryOperationsRequest.class, responseType = QueryOperationsResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<QueryOperationsRequest, QueryOperationsResponse> getQueryOperationsMethod() {
            ...
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            ...
                            io.grpc.stub.ServerCalls.asyncUnaryCall(
                                    new MethodHandlers<RegistryRequest, RegistryResponse>(
                                            this, METHODID_REGISTRY)))
                    .addMethod(
                            getQueryOperationsMethod(),
                            io.grpc.stub.ServerCalls.asyncUnaryCall(
                                    new MethodHandlers<QueryOperationsRequest, QueryOperationsResponse>(
