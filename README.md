...
- golang (version 1.19)
- kubernetes (kubectl)  
> There is some compatibility between kubernetes a docker, please check the version compatibility between them and download the corresponding version to ensure that they work properly together.
