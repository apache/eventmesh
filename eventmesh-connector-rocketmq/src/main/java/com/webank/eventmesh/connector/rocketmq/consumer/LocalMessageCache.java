...
import com.webank.eventmesh.connector.rocketmq.domain.ConsumeRequest;
...
public class LocalMessageCache implements ServiceLifecycle {
    ...
    public LocalMessageCache(final DefaultMQPullConsumer rocketmqPullConsumer, final ClientConfig clientConfig) {
    ...
    public long nextPullOffset(MessageQueue remoteQueue) {
    ...
    public void updatePullOffset(MessageQueue remoteQueue, long nextPullOffset) {
