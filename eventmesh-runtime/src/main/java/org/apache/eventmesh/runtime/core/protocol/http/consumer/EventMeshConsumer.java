...
public class EventMeshConsumer {
    ...
    public synchronized void init() throws Exception {
        ...
        keyValue.put(EventMeshConstants.CONSUMER_GROUP, consumerGroupConf.getConsumerGroup());
        keyValue.put(EventMeshConstants.EVENT_MESH_IDC, eventMeshHTTPServer.getEventMeshHttpConfiguration().eventMeshIDC);
        keyValue.put(EventMeshConstants.INSTANCE_NAME, EventMeshUtil.buildMeshClientID(consumerGroupConf.getConsumerGroup(),
        ...
        broadcastKeyValue.put(EventMeshConstants.CONSUMER_GROUP, consumerGroupConf.getConsumerGroup());
        broadcastKeyValue.put(EventMeshConstants.EVENT_MESH_IDC, eventMeshHTTPServer.getEventMeshHttpConfiguration().eventMeshIDC);
        broadcastKeyValue.put(EventMeshConstants.INSTANCE_NAME, EventMeshUtil.buildMeshClientID(consumerGroupConf.getConsumerGroup(),
            eventMeshHTTPServer.getEventMeshHttpConfiguration().eventMeshCluster));
