...
package org.apache.eventmesh.runtime.core.protocol.http.processor.event;
...
@Slf4j
public class ProcessorWrapperHandler {
    ...
    public void register(HttpProcessor httpProcessor, ThreadPoolExecutor threadPoolExecutor) {
        for (String path : httpProcessor.paths()) {
            ...
            if (httpProcessor instanceof AsyncHttpProcessor) {
                processorWrapper.asyncHttpProcessor = (AsyncHttpProcessor) httpProcessor;
            }
    ...
    class HandlerSpecific implements Runnable {
        ...
        public void run() {
            ...
            ProcessorWrapper processorWrapper = ProcessorWrapperHandler.this.httpProcessorMap.get(processorKey);
            try {
                this.preHandler();
                if (Objects.nonNull(processorWrapper.asyncHttpProcessor)) {
                    ...
                    processorWrapper.asyncHttpProcessor.handler(this, request);
                    return;
                }
        ...
        private void postHandler() {
            ...
            ProcessorWrapperHandler.this.sendResponse(ctx, this.request, this.response);
        }
    ...
    private static class ProcessorWrapper {
        ...
        private AsyncHttpProcessor asyncHttpProcessor;
