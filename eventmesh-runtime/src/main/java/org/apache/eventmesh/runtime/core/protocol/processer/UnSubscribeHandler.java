...
@ProtocolIdentifying(http="207")
public class UnSubscribeHandler implements EventMeshObjectProtocolHandler<SubscribeRequestBody> {
	...
	@Override
	public void handler(SubscribeRequestBody subscribeRequestBody, RpcContext rpcContext) throws Exception {
		eventMeshConsumerManager.unSubscribe(rpcContext);
	}
