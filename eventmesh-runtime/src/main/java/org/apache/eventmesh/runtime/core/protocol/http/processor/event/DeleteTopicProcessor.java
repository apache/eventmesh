...
import org.apache.eventmesh.runtime.core.local.HttpClientGroupMapping;
...
public class DeleteTopicProcessor implements AsyncHttpProcessor {
    ...
    @Override
    public void handler(ProcessorWrapperHandler.HandlerSpecific handlerSpecific, HttpRequest httpRequest)
        throws Exception {
        ...
        try {
            ...
            //validate topic is existed in eventmesh
            ...
            if (!faildTopic.isEmpty()) {
                ...
                sb.append(faildTopic).append(" not exist in eventmesh");
