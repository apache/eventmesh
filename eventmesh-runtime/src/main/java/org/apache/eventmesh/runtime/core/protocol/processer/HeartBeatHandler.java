...
@ProtocolIdentifying(http = {"203","/service/heartBeat"},tcp= {"HEARTBEAT_REQUEST"},grpc= {""})
public class HeartBeatHandler implements EventMeshProtocolHandler {
	...
	public void handler(EventMeshRequest eventMeshRequest, RpcContext rpcContext) throws Exception {
		sessionSerivce.hearBeat(rpcContext);
	}
