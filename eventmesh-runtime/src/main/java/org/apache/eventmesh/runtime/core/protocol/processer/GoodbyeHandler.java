...
@ProtocolIdentifying(http= {"203"})
public class GoodbyeHandler implements EventMeshObjectProtocolHandler<Object>{

	@Setter
	private SessionSerivce sessionSerivce;
	
	@Override
	public void handler(Object eventMeshRequest, RpcContext rpcContext) throws Exception {
		sessionSerivce.deleteSession(rpcContext);
	}
