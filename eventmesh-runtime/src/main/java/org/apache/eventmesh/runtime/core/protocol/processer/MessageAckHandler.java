...
@ProtocolIdentifying(tcp= {"ASYNC_MESSAGE_TO_CLIENT_ACK","REQUEST_TO_CLIENT_ACK","BROADCAST_MESSAGE_TO_CLIENT_ACK","RESPONSE_TO_CLIENT_ACK"})
public class MessageAckHandler implements EventMeshProtocolHandler {
    ...
    public void handler(EventMeshRequest eventMeshRequest, RpcContext rpcContext) throws Exception{
    	eventMeshEventCloudService.consumeAck(eventMeshRequest.getSeq());
    }
}
