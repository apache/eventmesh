...
public class ClientDisConnectProcessor extends AbstractMqttProcessor {

    public ClientDisConnectProcessor(EventMeshMQTTServer eventMeshMQTTServer) {
        super(eventMeshMQTTServer);
    }

    public ClientDisConnectProcessor(EventMeshMQTTServer eventMeshMQTTServer, Executor executor) {
    ...
    public void process(ChannelHandlerContext ctx, MqttMessage mqttMessage) throws MqttException {
        clientManager.unregisterClient(ctx, mqttMessage);
    }
}
