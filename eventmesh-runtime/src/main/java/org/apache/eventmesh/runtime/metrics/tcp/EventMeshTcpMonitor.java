        ...
        monitorTpsTask = eventMeshTCPServer.getScheduler().scheduleAtFixedRate((new Runnable() {
            ...
            public void run() {
                ...
                while (sessionIterator.hasNext()) {
                    ...
                    tcpLogger.info("session|deliveredFailCount={}|deliveredMsgsCount={}|"
                                    + "unAckMsgsCount={}|sendTopics={}|subscribeTopics={}|user={}",
                ...
                appLogger.info(String.format(MonitorMetricConstants.EVENTMESH_MONITOR_FORMAT_COMMON,
                        ...
                        MonitorMetricConstants.CLIENT_2_EVENTMESH_TPS, client2eventMeshTPS));
                appLogger.info(String.format(MonitorMetricConstants.EVENTMESH_MONITOR_FORMAT_COMMON,
                        EventMeshConstants.PROTOCOL_TCP,
                        MonitorMetricConstants.EVENTMESH_2_MQ_TPS, eventMesh2mqTPS));
                appLogger.info(String.format(MonitorMetricConstants.EVENTMESH_MONITOR_FORMAT_COMMON,
                        EventMeshConstants.PROTOCOL_TCP,
                        MonitorMetricConstants.MQ_2_EVENTMESH_TPS, mq2eventMeshTPS));
                appLogger.info(String.format(MonitorMetricConstants.EVENTMESH_MONITOR_FORMAT_COMMON,
                        EventMeshConstants.PROTOCOL_TCP,
                        MonitorMetricConstants.EVENTMESH_2_CLIENT_TPS, eventMesh2clientTPS));
                appLogger.info(String.format(MonitorMetricConstants.EVENTMESH_MONITOR_FORMAT_COMMON,
                ...
                appLogger.info(String.format(MonitorMetricConstants.EVENTMESH_MONITOR_FORMAT_COMMON,
                        EventMeshConstants.PROTOCOL_TCP, MonitorMetricConstants.SUB_TOPIC_NUM,
                        subTopicNum));
            }
...
//                ThreadPoolHelper.printThreadPoolState();
                ...
                appLogger.info(String.format(MonitorMetricConstants.EVENTMESH_MONITOR_FORMAT_COMMON,
                        EventMeshConstants.PROTOCOL_TCP, MonitorMetricConstants.RETRY_QUEUE_SIZE,
                        retrySize));
            }
