...
public class StorageResource {
    ...
    private static final Map<String, StorageResource> CONNECTOR_RESOURCE_CACHE = new HashMap<>(16);
    ...
    public static StorageResource getInstance(String connectorResourcePluginType) {
    ...
    private static StorageResource connectorResourceBuilder(String connectorResourcePluginType) {
        ...
        StorageResource connectorResource = new StorageResource();
