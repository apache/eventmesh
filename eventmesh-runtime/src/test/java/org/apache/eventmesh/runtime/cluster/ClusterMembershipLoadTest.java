...
class ClusterMembershipLoadTest {
    ...
    void heartbeatWritesLoadAndAddress() {
        ...
        assertEquals("0|self:10105|3|2000|1500|0.25", val);
    }
    ...
    void heartbeatWithoutLoadSupplierOmitsLoadFields() {
        AtomicClock clock = new AtomicClock();
        InMemoryMetaStore meta = new InMemoryMetaStore();
        ClusterMembership m = new ClusterMembership(meta, "self", "1.2.3.4:10105", 15_000L, clock::get, new FencingToken());
        m.heartbeat();
        assertEquals("0|1.2.3.4:10105", meta.get(ClusterMembership.INSTANCE_PREFIX + "self"));
    }
    ...
    void liveInstancesWithLoadParsesAllPeers() {
        ...
        meta.put("/em/instances/a", "19000|h1:10105|5|5000|4000|0.10"); // age 1000 < ttl
        meta.put("/em/instances/b", "19500|h2:10105|20|5000000|4000000|0.90"); // heavy, age 500 < ttl
        meta.put("/em/instances/c", "1000|h3:10105|1|100|50|0.01"); // age 19000 > ttl 15000 → pruned
        ClusterMembership m = new ClusterMembership(meta, "self", "self:10105", 15_000L, clock::get, new FencingToken());
    ...
    void setSelfAddressOverridesPlaceholder() {
        ...
        m.setSelfAddress("10.0.0.5:10105");
        // addressOf(self) returns the overridden address.
        assertEquals("10.0.0.5:10105", m.addressOf("self"));
    }
    ...
    void peerWithoutLoadReportsNullSnapshot() {
        ...
        InMemoryMetaStore meta = new InMemoryMetaStore();
        meta.put("/em/instances/old", "9500|h:10105"); // old-format peer, no load fields
        ClusterMembership m = new ClusterMembership(meta, "self", "self:10105", 15_000L, clock::get, new FencingToken());
        Map<String, ClusterMembership.InstanceInfo> live = m.liveInstancesWithLoad();
        assertEquals("h:10105", live.get("old").address);
    ...
    void snapshotLoadHandlesPartialFields() {
        ...
        AtomicClock clock = new AtomicClock(10_000L);
        InMemoryMetaStore meta = new InMemoryMetaStore();
        meta.put("/em/instances/p", "9500|h:10105|7|300");
        ClusterMembership m = new ClusterMembership(meta, "self", "self:10105", 15_000L, clock::get, new FencingToken());
