...
public final class HeartbeatServiceGrpc {
    ...
    public static final String SERVICE_NAME = "eventmesh.client.HeartbeatService";

    // Static method descriptors that strictly reflect the proto.
    private static volatile io.grpc.MethodDescriptor<org.apache.eventmesh.client.grpc.protos.Heartbeat,
            org.apache.eventmesh.client.grpc.protos.Response> getHeartbeatMethod;

    @io.grpc.stub.annotations.RpcMethod(
            fullMethodName = SERVICE_NAME + '/' + "heartbeat",
            requestType = org.apache.eventmesh.client.grpc.protos.Heartbeat.class,
            responseType = org.apache.eventmesh.client.grpc.protos.Response.class,
            methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<org.apache.eventmesh.client.grpc.protos.Heartbeat,
            org.apache.eventmesh.client.grpc.protos.Response> getHeartbeatMethod() {
        io.grpc.MethodDescriptor<org.apache.eventmesh.client.grpc.protos.Heartbeat, org.apache.eventmesh.client.grpc.protos.Response> getHeartbeatMethod;
            ...
            synchronized (HeartbeatServiceGrpc.class) {
                if ((getHeartbeatMethod = HeartbeatServiceGrpc.getHeartbeatMethod) == null) {
                    HeartbeatServiceGrpc.getHeartbeatMethod = getHeartbeatMethod =
                            io.grpc.MethodDescriptor.<org.apache.eventmesh.client.grpc.protos.Heartbeat, org.apache.eventmesh.client.grpc.protos.Response>newBuilder()
                                    .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                                    .setFullMethodName(generateFullMethodName(
                                            "eventmesh.client.HeartbeatService", "heartbeat"))
                                    .setSampledToLocalTracing(true)
                                    .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            org.apache.eventmesh.client.grpc.protos.Heartbeat.getDefaultInstance()))
        ...
        public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            ...
                            asyncUnaryCall(
                                    new MethodHandlers<
                                            org.apache.eventmesh.client.grpc.protos.Heartbeat,
    ...
    public static final class HeartbeatServiceBlockingStub extends io.grpc.stub.AbstractStub<HeartbeatServiceBlockingStub> {
         ...
         *
         */
        public org.apache.eventmesh.client.grpc.protos.Response heartbeat(org.apache.eventmesh.client.grpc.protos.Heartbeat request) {
    ...
    public static final class HeartbeatServiceFutureStub extends io.grpc.stub.AbstractStub<HeartbeatServiceFutureStub> {
         ...
         *
         */
        public com.google.common.util.concurrent.ListenableFuture<org.apache.eventmesh.client.grpc.protos.Response> heartbeat(
                org.apache.eventmesh.client.grpc.protos.Heartbeat request) {
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_HEARTBEAT:
                    serviceImpl.heartbeat((org.apache.eventmesh.client.grpc.protos.Heartbeat) request,
                            (io.grpc.stub.StreamObserver<org.apache.eventmesh.client.grpc.protos.Response>) responseObserver);
                    break;
                default:
